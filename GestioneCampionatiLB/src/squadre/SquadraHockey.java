...
/**
 * Classe che rappresenta una squadra di Hockey
 ...
 *
 */
public class SquadraHockey extends Squadra
{
	private static final long serialVersionUID = 1L;
	private int numPareggi;
	
	/**
	 * Costruttore che inizializza le variabili della squadra di Hockey con valori esterni
	 ...
	 */
	public SquadraHockey (String nome, String citta, ImageIcon logo, int numSetVinti, int numSetPersi, int punti, int numVittorie, int numSconfitte, int numPareggi)
	{
	...
	/**
	 * Metodo che imposta i punteggi in caso di assenza della squadra
	 * Diminuisce il numero dei punti di uno e incrementa il numero sconfitte
	 */
	public void Assenza()
	{
		super.setPunti(getPunti() - 1);
